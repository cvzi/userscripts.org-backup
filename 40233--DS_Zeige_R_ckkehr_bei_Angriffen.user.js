...
screenshot[0]: http://cuzi[--example.com--]/newhp_userscripts_screens/ds.showReturnTimeOnCommands_0.png
screenshot[1]: http://cuzi[--example.com--]/newhp_userscripts_screens/ds.showReturnTimeOnCommands_1.png
...
Version 1.14:
 - Update für Opera mit DS Version 8.17
...
api?api.register('DS Zeige Rückkehr bei Angriffen', [8.16, 8.17], 'cuzi', 'scripts@online.de'):0;
...
function countCanceling()
{
    if(canceling)
    {
        ...
        brokeUpReturn.innerHTML = text + '<span class="small grey">:'+arrival_milisec + '</span> Uhr)';
    }
}
...
function settings()
{
    ...
    allc.appendChild(d.text('(c) 2008 - 2009 example.com'));

    var close = d.n('img');
    close.setAttribute('src','http://www.example.com/close.png');
