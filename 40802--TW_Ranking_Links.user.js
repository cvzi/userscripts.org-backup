...
if (lang == 'pl')
{
    ...
    Text13=" example.com & Polska Wersja by Jurigag";
    Text14="DS Ranking Links - Version 1.2 - http://example.com & Polska Wersja by Jurigag";
}
else if (lang == 'de')
{
    Text0="Rang:";
    ...
    Text13=" example.com";
    Text14="DS Ranking Links - Version 1.2 - http://example.com";
}
else //if (lang== 'en')
{
    Text0="Rank:";
    ...
    Text13=" example.com & English Version by Jurigag";
    Text14="DS Ranking Links - Version 1.2 - http://example.com & English Version by Jurigag";
};
...
else if(url.indexOf('screen=info_ally') != -1)
{
    ...
    a.addEventListener('click',function(e) {
        ...
        var c = String.fromCharCode('0169')+' example.com';

        var span = document.createElement('span');
        span.setAttribute('style','font-size:smaller; float:right; ');
        span.setAttribute('title','DS Ranking Links - Version 1.2 - http://example.com');
        span.appendChild(document.createTextNode(c));
        div.appendChild(span);
