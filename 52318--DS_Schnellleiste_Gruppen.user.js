...
const srcs = {
  ...
  'delete' : 'http://www.example.com/smile/dsforum/trash.gif' }
...
function aboutMe()
  {
  var div = n('div',{'id':'about_me_52318','style':'font-family:sans-serif; color:Darkblue; position:absolute; top:30%; left:30%; background:url(http://example.com/images/gm_logo.png) no-repeat Silver bottom right ; border:solid black 2px;'},false,[say._name+' ('+version+')',
  ...
  'nor a part/parts of this code without permission from cuzi',
  '',
  ...
  div.appendChild(n('img',{'src':'http://www.example.com/close.png','alt':'Close()','style':'position:absolute; top:5px; right:5px; '},['click',function(){d(this.parentNode.id);},false]));
  dragable(div,1000);
  }
