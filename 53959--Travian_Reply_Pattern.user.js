...
if($('textmenu').getElementsByTagName('a')[1].getAttribute('class') == 'selected' && $('igm').firstChild)
  ...
  // Config Link:
  var a = $('btn_send').parentNode.appendChild(n('a',{'href':'#','title':'Travian Reply Pattern by example.com - Configuration','style':'font-size:smaller;'},['click',selfConfig,false],false,'Reply Pattern'));
  }