...
function showNoteInput(link)
  ...
  textarea.setAttribute('style','font-size:12px; background:white no-repeat url(http://example.com/images/gm_logo.png) bottom right;');
...
function showFavouriteBox(link)
  ...
  for(var i = 0,len = favouriteVillages.length; len > i; i++)
    ...
    var td0 = dom.n('td');
    var img = new Image();
    img.src = 'http://www.example.com/smile/dsforum/trash.gif';
    img.alt = 'Entfernen';
    var a = dom.n('a');
    a.setAttribute('href','#');
    a.appendChild(img);
