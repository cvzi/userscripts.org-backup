...
img.setAttribute('src','http://www.example.com/smile/dsforum/edit.gif');
...
function settings()
  ...
  allc.appendChild(document.createTextNode('Copyright 2009 by example.com'));
